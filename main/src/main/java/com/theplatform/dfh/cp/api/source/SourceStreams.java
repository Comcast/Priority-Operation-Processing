...
/**
 * TextResource Streams Part
 * The TextResource Streams part decomposes the sources into the individual streams of content that will be transcoded and packaged in the subsequent parts.
 ...
 * TextResource Streams are conceptual, meaning that describe what will be used as a transcoding/packaging source,
 * but there will not typically be a file on the file system that embodies this stream.
 * The TextResource Streams are grouped into the same categories as the Sources (VideoParam, AudioStream, Text, Metadata).
 */
