package com.comcast.pop.scheduling.master.aws;
...
import com.comcast.pop.endpoint.client.HttpObjectClientFactory;
...
public class AWSLambdaStreamEntryTest
{
    ...
    private void setupValidEnvironment()
    {
        ...
        environmentMap.put(AWSLambdaStreamEntry.ENV_RESOURCEPOOL_ENDPOINT_PATH, "/pop/resourcepool");
        environmentMap.put(AWSLambdaStreamEntry.ENV_RESOURCEPOOL_LAMBDA_LAUNCH_LIST, "pop-SchedulingQueue-HIDXPAS4J9VX");
