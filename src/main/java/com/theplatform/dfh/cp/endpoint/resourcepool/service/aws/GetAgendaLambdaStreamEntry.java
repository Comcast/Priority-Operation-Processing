 ...
 */
public class GetAgendaLambdaStreamEntry extends AbstractLambdaStreamEntry<GetAgendaResponse, LambdaRequest<GetAgendaRequest>>
{
    ...
    public RequestProcessor getRequestProcessor(LambdaRequest<GetAgendaRequest> lambdaRequest)
    {
        ...
        return new AgendaServiceRequestProcessor(infoItemQueueFactory, insightPersister, agendaPersister, resourcePoolPersister);
    }
