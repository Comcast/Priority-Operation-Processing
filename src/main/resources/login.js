function getQueryURL(server, endpoint)
{
...
function authorizeWithLambda(e) {
    ...
    $.ajax({
        ...
        success: function (idmResponse) {
            ...
            $.ajax({
                type: "GET",
                url: getQueryURL(server, endpoint),
                crossDomain: true,
                jsonp: true,
...
// function authorizeWithLambdaForLinkId(e) {
//     e.preventDefault();
//
//     if ($("#mpx_username").val()=="") {
//         alert ("Please enter your user id");
...
//
//     var server = servers[targetServerIndex];
//     var agendaEndpoint = endpoints["Agenda"];
//
//     getEndpointURL(server, agendaEndpoint);
//
//     // agenda progress: get by linkId
//
//     //alert(queryURL);
//
//     //    {"signInResponse":{"token":"XYZ","userId":"http://identity.auth.test.corp.theplatform.com/idm/data/User/mpx/ZZZ","userName":"me@me.com","duration":86400000,"idleTimeout":14400000}}
...
//             $.ajax({
//                 type: "GET",
//                 url: getQueryURL(targetServerIndex, targetEndpointIndex),
//                 crossDomain: true,
//                 jsonp: true,
//                 contentType: "application/json",
//                 headers: {
