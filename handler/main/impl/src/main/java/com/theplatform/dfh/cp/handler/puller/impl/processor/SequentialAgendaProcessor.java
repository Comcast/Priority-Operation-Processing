...
import com.theplatform.dfh.cp.handler.puller.impl.exception.AgendaExecutorException;
import com.theplatform.dfh.cp.handler.puller.impl.executor.BaseOperationExecutor;
import com.theplatform.dfh.cp.handler.puller.impl.executor.kubernetes.KubernetesOperationExecutor;
...
public class SequentialAgendaProcessor implements HandlerProcessor<Void>
{
    ...
    public Void execute()
    {
        PullerHandlerInput handlerInput;
        try
        {
            handlerInput = jsonHelper.getObjectFromString(launchDataWrapper.getPayload(), PullerHandlerInput.class);
