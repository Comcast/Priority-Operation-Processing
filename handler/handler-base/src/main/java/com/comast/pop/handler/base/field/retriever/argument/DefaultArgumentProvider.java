package com.comast.pop.handler.base.field.retriever.argument;
...
public class DefaultArgumentProvider extends ArgumentProvider
{
    ...
    protected Options getOptions()
    {
        ...
        addOption(options, HandlerArgument.LAST_PROGRESS_FILE, true, "The path to an operation progress file to use. This overrides the environment variable.");
