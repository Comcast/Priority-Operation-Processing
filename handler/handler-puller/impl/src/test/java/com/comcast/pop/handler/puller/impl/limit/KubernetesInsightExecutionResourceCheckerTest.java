...
public class KubernetesInsightExecutionResourceCheckerTest
{
    ...
    public void liveTestOfPodQuery()
    {
        ...
        doReturn("https://api.k8s.com").when(mockPropertiesRetriever).getField(KubeConfigField.MASTER_URL.getFieldName());
        doReturn("pop").when(mockPropertiesRetriever).getField(KubeConfigField.NAMESPACE.getFieldName());
