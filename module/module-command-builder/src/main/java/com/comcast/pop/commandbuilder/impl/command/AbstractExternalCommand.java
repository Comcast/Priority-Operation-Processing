...
import com.comcast.pop.commandbuilder.impl.command.api.Phase.UnknownPhase;
...
public abstract class AbstractExternalCommand implements ExternalCommand
    ...
    protected AbstractExternalCommand(String programName)
        ...
        {
            if(!RuleFactoryUtil.FORBIDDEN_CHARACTERS.test(programArgumentList.toArray(new String[0])))
            {
